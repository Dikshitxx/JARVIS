...
MAX_TOOL_STEPS = 4
DIRECT_REPLY_TOOLS = {"remember_fact", "forget_memory", "list_memories", "open_app", "close_app", "take_screenshot", "remember_person", "list_known_people", "move_mouse", "click_mouse", "type_text", "press_key", "start_project", "stop_project", "project_status"}
